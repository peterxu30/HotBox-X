...
public class GameMain implements Screen {
	...
	private static final float topBoundary = 650f;
	...
	private float obstacleWidth = 60f;
	...
	private void config() throws IOException {
		...
		obstacleWidth = ((Double) configMap.get("obstacleWidth")).floatValue();
		...
		waveTime = ((Integer) configMap.get("waveTime")).longValue() 
				 * ((Integer) configMap.get("waveTimeMultiplier")).longValue();
	...
	private void restoreConfig() throws IOException {
		File backupFile = new File("bin/config/config.yml");
